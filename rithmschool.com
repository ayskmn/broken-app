...
<meta name="csrf-token" content="OGbtqUxTs2/pHB1xyGJyBvq9m3VMyi2EpXr5AliLD/qPqrhJUSZN+SPR6viCyN3deYE3ViGe10Le1AkyxWOSsw==" />
...
<header id="home-image">
    <div class="intro-text full-width home">
        ...
        <div class="header-text">
          ...
          <h4 class="text-muted">Next course starts January 10th in person and online.</h4>
        </div>
    </div>
</header>
  ...
  <div id="hero-background" class="full-width">
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <a class="btn btn-cta-right" href="https://calendly.com/rithmadmissions/rithm-school-chat">Chat with our Academic Adviser</a>
      </div>
    </div>
  </div>
</div>
        ...
        <div class="col-md-3 col-sm-4 text-center">
            <a style="padding:0;" class="footer-logo" href="/">
              <img class="logo" width="120" height="58" alt="rithm school company logo" title="Rithm School Logo" src="/assets/logos/rithm_logo-0bbe0cba0becc168bb1ed46540bd26d6921d9f5194372128512268c203687780.svg" />
                ...
                <a class="text-muted faq-url" href="/cdn-cgi/l/email-protection#dbb2b5bdb49ba9b2afb3b6a8b8b3b4b4b7f5b8b4b6">info@rithmschool.com</a>
            </span>
        </div>
...
<input type="hidden" name="authenticity_token" id="authenticity_token" value="peOWcW9Z2SGlkpNyywWmzHXH8qxGT0S4FyLUdcNEK7ASL8ORciwnt29fZPuBrwkX9vtejysbvn5sjCRFXqy2+Q==" />  <div id="modal-email-known" style="display:none;">
